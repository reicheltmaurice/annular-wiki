...
Interne Chronologie (Autorenebene). Erzählreihenfolge der Kapitel: [Kapitelstruktur](Kapitelstruktur.md). Jahre relativ zu **Girlins Verschwinden = Jahr 0** (dem auslösenden Ereignis). Konkrete Jahreszahlen erscheinen nicht im Erzähltext (Referenzjahr 550 n.Chr., siehe [C-001](../../Notizen/Challenges.md)).
...
- Semund bindet sich **rasch** neu an [Millia](../../Menschen/Nordvolk/Nebenfiguren/Millia.md) — für Tibun ein Verrat, denn er **weiß**, dass Girlin lebt ([C-022](../../Notizen/Challenges.md))
- **Der Unfall** (entschieden 02.09.2026, [C-058](../../Notizen/Challenges.md#c-058-wasserrad-unfall-und-tibuns-schuld)): Tibun baut etwas und **verletzt dabei eine Nebenfigur**. Dass es geschieht, steht fest; **womit** er baut und **wie** der Unfall abläuft, ist bewusst noch nicht entschieden · **???**
...
**Umgebaut am 02.09.2026** ([C-115](../../Notizen/Challenges.md#c-115-tibuns-wanderjahre--die-stationen-fehlen)). Die frühere Fassung ließ ihn *acht Jahre über den Ochsenweg wandern* — das war nie stimmig: Skirraa↔Kaupvik sind **~14 Tagesmärsche**, also zwei bis drei Wochen. Die acht Jahre sind **Kaupvik-Jahre**, keine Wanderjahre.
...
- **Die Reise: Wochen, nicht Jahre.** Genau **eine Zwischenstation**, an der er sich einer Gruppe anschließt, um weiterzureisen. Sie verändert **zweierlei**:
  - Er lernt, **ohne Sippe zu überleben** — Anschluss, Arbeit gegen Schutz. Damit ist [C-034](../../Notizen/Challenges.md#c-034-tibuns-lebensgrundlage-während-der-wanderschaft) im Kern beantwortet
  ...
  - **Offen:** wo diese Station liegt und was für eine Gruppe es ist · **???** → [C-124](../../Notizen/Challenges.md#c-124-die-zwischenstation--ort-und-gruppe)
- **[Kaupvik](../../Orte/Kaupvik.md), Jahr +1 bis +9 — rund acht Jahre an einem Ort.** Er bleibt aus zwei Gründen: Er **braucht das Wissen**, und er **sammelt Bernstein und Ressourcen** — durch Handel *und* durch eigenes Sammeln. Bernstein in der nötigen Menge ist nicht zu kaufen wie Brot; das Sammeln selbst kostet die Jahre
  - **+1 bis +4:** Hafenarbeit, die Zieheltern ([C-059](../../Notizen/Challenges.md#c-059-tibuns-zieheltern-in-kaupvik)), Sammeln und Handeln — noch ohne zu wissen, wie es geht
  - **+4/+5: Arbeitsunfall an einer Bootsziehwinde** → **Erkenntnismoment**: schnelle, kontinuierliche Reibung = viel Ladung ([C-002](../../Notizen/Challenges.md))
...
- **Die Zieheltern bleiben zurück** — lebend, im Guten. Ein Abschied, kein Verlust ([C-059](../../Notizen/Challenges.md#c-059-tibuns-zieheltern-in-kaupvik))
- **Folge:** Weil der Aufbruch nichts kostet, muss der Konflikt der Jahre +9/+10 **vollständig vom Dorf kommen** → [C-100](../../Notizen/Challenges.md#c-100-die-werkstatt-an-der-tabustelle). Vermerkt in [C-118](../../Notizen/Challenges.md#c-118-der-nordstrang-verliert-zwischen-1-und-9-nichts)
...
- **Der Konflikt mit dem Weiler** (entschieden 02.09.2026, [C-100](../../Notizen/Challenges.md#c-100-die-werkstatt-an-der-tabustelle)):
  ...
  - **Truda weiß, was er tut** — er sagt es ihr. Sie **hält ihn für verloren** und will ihn zur Vernunft bringen → [C-077](../../Notizen/Challenges.md#c-077-tibun-und-truda-nach-girlins-verschwinden)
...
Entschieden 31.08.2026. Löst [C-062 ✓](../../Notizen/Challenges.md#c-062-azzims-ankunft-vor-tibuns-zündung-): Nicht *entweder* Wüste *oder* Norden zündet — **beide, nacheinander**. Damit bleibt die Gleichzeitigkeit aus [C-012 ✓](../../Notizen/Challenges.md#c-012-aktivierungsverhalten-des-rings-) gültig, und Tibuns zehn Jahre Arbeit werden trotzdem ausgezahlt.
...
- Gegenrichtung: **kein Mensch** — nur Sand und Gerät ([C-102](../../Notizen/Challenges.md#c-102-was-bei-zündung-1-aus-dem-norden-verschwindet))
- Der **Skir-Ring** flippt mit. **Tibuns geladener Konduktor ist davon nicht betroffen** — die Kette liegt im Dachstuhl, der Stromkreis ist offen ([C-109 ✓](../../Notizen/Challenges.md#c-109-ladezeit-des-konduktors-)). Er kann **jederzeit** zünden; die Frage ist nur, ob er die Hand frei bekommt
...
- **Azzim begreift erst hier, was ihn geworfen hat** (entschieden 02.09.2026): Er steht vor demselben Ding wie in der Schlucht, in Wasser, das aus dem Nichts kam. Er schließt es **selbst** — nachdem er es zehn Jahre lang nicht wusste
  > **Korrigiert:** Die frühere Formulierung *„Azzim will zurück"* setzte voraus, dass er den Ring kennt. Das war nicht gedeckt → [C-119](../../Notizen/Challenges.md#c-119-wiki-altlast--vom-autor-nicht-gedeckte-festlegungen)
...
- **Tibun weiß, dass die Kugelgrenze schneidet.** Er hat zehn Winter die Sandmulde vor Augen gehabt: glatt durchtrennte Wurzeln, halbierte Steine ([C-098](../../Notizen/Challenges.md#c-098-woher-tibun-die-schnittwirkung-der-kugelgrenze-kennt-))

### Zündung 2 — Tibuns Auslösung
- Das **Bernsteinrad** lädt einen **isolierten Konduktor** ([C-099](../../Notizen/Challenges.md#c-099-der-isolierte-konduktor--ladungsspeicher-ohne-anachronismus)). Gezündet wird über eine **Kette**, die aus dem Dachstuhl der Werkstatt herabfällt und Konduktor und Ring verbindet — **punktuell, gezielt, augenblicklich**
...
- **Offen:** Wissen beide beim Schlusssatz, was er kostet? Der Ring **tauscht** — man kann niemanden rufen, der nicht schon dort steht. Leichthin gesagt wirkt der Satz naiv; im vollen Bewusstsein gesagt ist er der beste des Buchs ([C-110](../../Notizen/Challenges.md#c-110-der-schlusssatz--wissen-die-figuren-was-er-kostet)) · **???**
