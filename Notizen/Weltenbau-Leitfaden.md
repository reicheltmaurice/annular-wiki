...
- [x] **Ablage** (05.09.2026): Die Dublette ist aufgelöst. `Menschen/Wuestenvolk/Kel-Aman.md` ist in [Kulturen/Kel Aman](../Kulturen/Kel-Aman/README.md) aufgegangen, `allgemein.md` und `Karawanen.md` sind als [Erscheinung](../Kulturen/Kel-Aman/Erscheinung.md) und [Karawanen](../Kulturen/Kel-Aman/Karawanen.md) dorthin verschoben. `Menschen/Wuestenvolk/` trägt nur noch Figuren. Was aus der Zeit vor der Verortung stammt, ist dort jetzt als Altmaterial ausgewiesen statt als Bestand.
