...
Angelegt am 04.09.2026. Der Autor hat „Der Blitz" in zwei Karten geteilt: **Der Blitz — Tibun** (Nr. 3) und **Der Blitz — Girlin** (Nr. 4), derselbe Moment aus beiden Sichten. Girlins Karte endet dort, wo es für sie schwarz wird; das Aufwachen bleibt bei „Ankunft im Fezzan".

**Damit existiert eine Szene, für die das Wiki fast nichts hergibt.** Gedeckt ist nur:
...
**Offen · ???** Alles, woraus die Szene besteht:

1. **Sieht sie den Ring?** Merkt sie, worin sie steht — oder trifft es sie aus dem Nichts? [C-020](#c-020-vorwarnung-vor-dem-flip-) (Vorwarnung durch aufleuchtende Runen) ist unentschieden; die dort notierte Tendenz stammt von Claude, nicht vom Autor, und trägt hier nichts.
2. **Wie endet ihre Wahrnehmung?** Schlagartig, oder gibt es einen Augenblick dazwischen?
3. **Was will sie in diesem Moment?** Das Feld *Will* der Karte steht auf `???`, ebenso *Hindernis* — sie ist bisher reiner Zustand.

**Der Widerspruch, auf den zu achten ist:** [C-114 ✓](#c-114-girlin-weiß-von-anfang-an-dass-der-ring-ihr-rückweg-ist-) setzt voraus, dass sie **weiß**, dass ein Ring sie hergebracht hat. Nimmt sie in dieser Szene nichts wahr, muss dieses Wissen anderswo herkommen — aus dem, was sie am Ankunftsort sieht, oder von den Kel Aman, die das Ereignis von Weitem beobachten. Beides ist nicht festgelegt.
