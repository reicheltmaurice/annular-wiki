...
- Der Turm, der als Verteilungsstelle mit vielen Loopringen benutzt wird.
  - Man portet oben rein, fällt runter und portet irgendwo wieder raus.
  - Ausgeklügeltes Timing-System

Man springt oben rein **oder** portet in einen oberen Ring, fällt runter und wählt vorher, welches Ziel man hat — also **welcher der Ringe zünden soll**.

---

## Was die Ringmechanik dazu sagt

Nur zur Einordnung, nichts davon ist entschieden. Grundlage: [Portalringe.md](../Technik/Portalringe.md).
...
**Was zurückkommt:** Der Tausch ist hart und 1:1. Was aus dem Turm verschwindet, wird durch das Volumen der Gegenseite ersetzt — bei einem Ziel im Sand also durch **Sand**, der dann in den Schacht fällt. Gegenstellen eines Turmringes müssten ebenfalls leer/luftgefüllt sein.
